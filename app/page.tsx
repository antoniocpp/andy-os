...
import { Mic, Database, BookOpen, Workflow, Zap, Cpu, BrainCircuit } from "lucide-react";
...
export default async function CockpitPage() {
  ...
  return (
    <PageShell activePath="/" title="Cockpit" path="Visão Geral">
      <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", height: "100%", overflow: "hidden", paddingBottom: 60 }}>
        <div style={{ borderRight: "1px solid #1B2A36", display: "flex", flexDirection: "column", overflow: "hidden" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "11px 14px 10px", borderBottom: "1px solid rgba(39,182,214,0.18)" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 13, paddingTop: 12 }}>
              ...
              <div>
                ...
                <div style={{ display: "flex", gap: 4, marginTop: 7, flexWrap: "wrap" }}>
                  {[["29 skills","#27B6D6"],["4 MCPs","#44D083"],["Sonnet 4.6","#F0B84A"]].map(([l,c])=>(
        ...
        <div style={{ display: "flex", flexDirection: "column", overflow: "hidden" }}>
          <div style={{ display:"flex",alignItems:"center",gap:8,padding:"11px 14px 10px",borderBottom:"1px solid rgba(200,232,0,0.18)" }}>
            <div style={{ width:7,height:7,borderRadius:"50%",background:"#C8E800",boxShadow:"0 0 6px rgba(200,232,0,0.7)" }} />
            <span style={{ fontFamily:'"IBM Plex Mono",monospace',fontSize:9,fontWeight:700,letterSpacing:"0.14em",textTransform:"uppercase",color:"#C8E800" }}>Live Activity</span>
            <div style={{ flex:1,height:1,background:"linear-gradient(90deg,rgba(200,232,0,0.28),transparent)" }} />
          </div>
          <div style={{ padding:"4px 12px 6px",borderBottom:"1px solid rgba(255,255,255,0.04)" }}>
